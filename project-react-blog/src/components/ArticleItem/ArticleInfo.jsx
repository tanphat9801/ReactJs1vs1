...
import { DATE_CREATE } from "../../constants";

dayjs.extend(relativeTime);
dayjs.locale(localeVi);

const ArticleItemInfo = ({ isShowAvatar, author, createDate, authorLink }) => {
  const dateFormat = dayjs(createDate);
  const createDateFormat = dateFormat.format(DATE_CREATE);
  const dateFormatFromNow = dateFormat.fromNow();
      ...
      <div className="article-item__info">
        ...
        <div className="article-item__info-right">
          ...
          <div className="article-item__datetime">
            <div className="date">{createDateFormat}</div>
            <div className="time">
              &nbsp;
              <svg
                stroke="currentColor"
